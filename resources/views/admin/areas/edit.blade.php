...
@section('content_header')
    <h1>Crear Nuevo Área</h1>
@stop

@section('content')
    <p>Administrador de Áreas</p>


	<div class="card">
		<div class="card-body">
			<a href="{{ route('admin.areas.index') }}" class="btn btn-info"><i class="fas fa-list-ul mr-2"></i> Ver listado de Áreas</a>
		</div>
	</div>
						...
						<div class="card-body">
							<div class="form-row">
								<div class="form-group col-md-8">
									...
									<input type="text" class="form-control" name='name' placeholder="Área, (Administración, Contabilidad, etc)" value="{{ old('name', $area->name) }}">
									@error('name')
